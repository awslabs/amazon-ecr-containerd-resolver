#!/bin/bash -e
set -e
echo "10gb-15-layer-no-concurrency-parallelism" >> results_averages.json
...
for j in $(seq 1 1); do
  ...
  IMAGE_URL="ecr.aws/arn:aws:ecr:us-west-1:020023120753:repository/10gb-unity-15-layer:latest"
